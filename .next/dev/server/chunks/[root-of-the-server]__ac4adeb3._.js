...
function createPrismaClient() {
    // Use DIRECT_URL (port 5432) and remove sslmode for Windows compatibility
    let connectionString = process.env.DIRECT_URL || process.env.DATABASE_URL;
    // Remove sslmode from connection string for Windows dev environment
    connectionString = connectionString.replace(/[?&]sslmode=[^&]+/g, "");
    connectionString = connectionString.replace(/\?$/, ""); // Clean trailing ?
    // Create pg Pool without SSL for Windows development
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ac4adeb3._.js.map